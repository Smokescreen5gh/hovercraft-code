...
void loop() { 
  ...
  { 
      ...
      { 
          ...
          Serial.println(telemetryRx.telemetry.Servo_1_Angle); 
 
          Serial.print(">Servo 2 Angle: "); 
          Serial.println(telemetryRx.telemetry.Servo_2_Angle); 
 
          Serial.print(">Servo 3 Angle: "); 
          Serial.println(telemetryRx.telemetry.Servo_3_Angle); 
 
          Serial.print(">Servo 4 Angle: "); 
          Serial.println(telemetryRx.telemetry.Servo_4_Angle); 
  ...
  static uint32_t lastControlMs = 0; 
    ...
    { 
        ...
        // Joystick 1 
        out.control.joy1X = joy1.getX(); 
        out.control.joy1Y = joy1.getY(); 
        out.control.joy1Button = joy1.getButtonState(); 
 
        // Joystick 2 
        out.control.joy2X = joy2.getX(); 
        out.control.joy2Y = joy2.getY(); 
        out.control.joy2Button = joy2.getButtonState(); 
 
        // Potentiometers 
        out.control.pot1 = pot1.getValue(); 
        out.control.pot2 = pot2.getValue(); 
        out.control.pot3 = pot3.getValue(); 
 
        // Toggle switches 
        out.control.switch1 = Switch1.isOn(); 
        out.control.switch2 = Switch2.isOn(); 
        out.control.switch3 = Switch3.isOn(); 
  ...
  if (nowMs - lastDisplayMs >= 200) { 
    ...
    transmitter_info.update( 
      ...
      telemetryRx.telemetry.motor_1_state, 
      telemetryRx.telemetry.motor_2_state, 
      telemetryRx.telemetry.motor_3_state, 
      telemetryRx.telemetry.motor_4_state, 
      telemetryRx.telemetry.motor_5_state, 
      telemetryRx.telemetry.motor_6_state 
    ); 
  } 
